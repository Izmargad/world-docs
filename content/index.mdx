---
title: "Just fantasy"
description: "MDX documentation site for Kyrkon."
---

Welcome to the MDX documentation site for a parallel world, named Kyrkon. This site is based on the original Gatsby.js theme, as developed by Code Bushi. This is an experiment to see how quickly and easily it is to create documentation using MDX or Markdown.
...
* Part II: The Codex itself and
* Part III: Technical Reference Material 

### Part I: Reference Material 

The first part of the site consists of reference material, documented systematically used in the second part of the codex, in which the world is described.

### Part II: Codex of Kyrkon

The structure of the second part is described here...

### Part III Technical Reference material

Some reference links to the original theme and demo site:

- [Code Bushi](https://codebushi.com/gatsby-starters-and-themes/). 
- [View the Live Demo](https://gatsby-theme-document.netlify.com/).
- [OnGithub](https://github.com/codebushi/gatsby-theme-document).
- [MDX](https://mdxjs.com/).
